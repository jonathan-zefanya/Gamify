                    ...
                    <div class="sidebar-card-box">
                        ...
                        <div class="progress-box mt-20">
                            <div class="progress-item">
                                ...
                                <div class="progress">
                                    <div class="progress-bar" data-progress="{{ $game->total_review > 0 ? ($reviewStatic['excellentCount'] * 100) / $game->total_review : 0 }}"></div>
                                </div>
                            ...
                            <div class="progress-item">
                                ...
                                <div class="progress">
                                    <div class="progress-bar"
                                         data-progress="{{ $game->total_review > 0 ? ($reviewStatic['greatCount'] * 100) / $game->total_review : 0 }}">
                                    </div>
                                </div>
                            ...
                            <div class="progress-item">
                                ...
                                <div class="progress">
                                    <div class="progress-bar"
                                         data-progress="{{ $game->total_review > 0 ? ($reviewStatic['averageCount'] * 100) / $game->total_review : 0 }}">
                                    </div>
                                </div>
                            ...
                            <div class="progress-item">
                                ...
                                <div class="progress">
                                    <div class="progress-bar"
                                         data-progress="{{ $game->total_review > 0 ? ($reviewStatic['poorCount'] * 100) / $game->total_review : 0 }}">
                                    </div>
                                </div>
                            ...
                            <div class="progress-item">
                                ...
                                <div class="progress">
                                    <div class="progress-bar"
                                         data-progress="{{ $game->total_review > 0 ? ($reviewStatic['badCount'] * 100) / $game->total_review : 0 }}">
                                    </div>
                                </div>
                            ...
                            @if(!empty($reviewStatic['excellentReview']))
                                @forelse($reviewStatic['excellentReview'] as $excellent)
                                    <div class="reviews-single grid-item excellent all">
                                        <div class="left-side">
                                            <div class="img-box">
                                                <img src="{{getFile($excellent->user?->image_driver,$excellent->user?->image)}}" alt="{{ $excellent->user?->fullname }}">
                                            </div>
                                            <div class="text-box">
                                                <div class="title">
