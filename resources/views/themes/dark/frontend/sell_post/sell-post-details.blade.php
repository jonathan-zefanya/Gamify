            ...
            <div class="row g-4 g-xxl-5">
                <div class="col-lg-7">
                    <div class="product-box3">
                        <div class="text-area-inside d-flex justify-content-center gap-3">
                            ...
                            <div class="text-box">
                                ...
                                @else
                                    @if($sellPost->payment_lock == 1)
                                        ...
                                        @elseif(Auth::check() &&  Auth::id()==$sellPost->user_id)
                                            <span class="badge text-bg-info">@lang('Payment Processing')</span>
                                        @else
                                ...
                                @if($sellPost->post_specification_form)
                                    <div class="d-flex justify-content-between gap-3 mt-2 post_specification_form">
                    ...
                    <div class="col-md-5">
                        <div class="custom-card">
                            <div class="contact-box ">
                                <div class="offer-maker-list dark-offer-maker-list">
                                    ...
                                    @forelse($sellPostOffer as $k => $row)
                                        <div class="sellpost-offer-box d-flex">
                                            <div class="flex-shrink-0">
                                                <a href="javascript:void(0)" class="d-lg-block d-none"
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="post-user-info d-flex gap-1 align-items-center">
                                                        <a href="javascript:void(0)" class="d-lg-none d-block"
                                                           title="{{optional($row->user)->username}}">
                                                            <img src="{{ getFile(auth()->user()->image_driver, auth()->user()->image) }}" class="rounded-circle"
                                                                 width="35" height="35" alt="Sample Image">
                                                        </a>
