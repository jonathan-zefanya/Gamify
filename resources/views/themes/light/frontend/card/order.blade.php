                            ...
                            <div class="card-body">
                                ...
                                <div class="payment-section">
                                    <ul class="payment-container-list">
                                        <li class="item">
                                            <input class="form-check-input methodId" type="radio" value="-1" name="gateway_id"
                                                   id="wallet" checked>
                    ...
                    <div class="card mb-20">
                        <div class="card-body">
                            ...
                            <div class="search-box2">
                                ...
                                <button type="button" class="search-btn2" onclick="couponApply('${orderNumber}')">@lang('Apply')</button>
                            </div>
