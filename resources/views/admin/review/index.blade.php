            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{$reviews['todayReview']??0}}</span>
                                <span class="text-body fs-5 ms-1">@lang("From") {{$reviews['totalReview']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-info text-info p-1">
                                <i class="bi-graph-down"></i> {{ number_format($reviews['todayReviewPercentage'] , 2)}}%
                              </span>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="filter_form">
                                                <div class="mb-4">
                                                            <span
                                                                class="text-cap text-body">@lang('Game Name')</span>
                                                    <div class="row">
                                                        <div class="col-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm mb-4">
                                                        <small class="text-cap text-body">@lang('Rating')</small>
                                                        <div class="tom-select-custom">
                                                            <select
                                                                ...
                                                                <option value="all"
                                                                        data-option-template='<span class="d-flex align-items-center"><span class="legend-indicator bg-secondary"></span>All Rating</span>'>
                                                                </option>
                                                                <option value="5"
                                                                        data-option-template='<span class="d-flex align-items-center"><span class="legend-indicator bg-success"></span>5 Star</span>'>
                                                                </option>
                                                                <option value="4"
                                                                        data-option-template='<span class="d-flex align-items-center"><span class="legend-indicator bg-primary"></span>4 Star</span>'>
                                                                </option>
                                                                <option value="3"
                                                                        data-option-template='<span class="d-flex align-items-center"><span class="legend-indicator bg-info"></span>3 Star</span>'>
                                                                </option>
                                                                <option value="2"
                                                                        data-option-template='<span class="d-flex align-items-center"><span class="legend-indicator bg-dark"></span>2 Star</span>'>
                                                                </option>
                                                                <option value="1"
                                                                        data-option-template='<span class="d-flex align-items-center"><span class="legend-indicator bg-danger"></span>1 Star</span>'>
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                let filterRating = $('#filter_rating').val();
                let filterDate = $('#filter_date_range').val();

                const datatable = HSCore.components.HSDatatables.getItem(0);
                datatable.ajax.url("{{ route("admin.review.search") }}" + "?name=" + name +
                    "&filterDate=" + filterDate + "&filterStatus=" + filterStatus + "&filterRating=" + filterRating).load();
            });
