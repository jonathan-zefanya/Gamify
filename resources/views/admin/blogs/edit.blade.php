                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        ...
                                        <h5>@lang('Image size should be') {{config('filelocation.blog.preview_img')}} @lang('for better resolution')</h5>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        <label for="" class="form-label">@lang("Banner Image")</label>
                                        <label class="form-check form-check-dashed" for="BannerImageUploader">
                                            <img id="BannerImg"
                                                 class="avatar avatar-xl avatar-4x3 avatar-centered h-100 mb-2"
                                                 src="{{ getFile($blog->banner_image_driver, $blog->banner_image, true) }}"
                                                 alt="@lang("Breadcrumb Image")"
                                                 data-hs-theme-appearance="default">
                                            ...
                                            <span class="d-block">@lang("Browse your file here")</span>
                                            <input type="file" class="js-file-attach form-check-input"
                                                   name="banner_image" id="BannerImageUploader"
                                                   data-hs-file-attach-options='{
                                                  "textTarget": "#BannerImg",
                                                  "mode": "image",
                                                  "targetAttr": "src",
                                                  "allowTypes": [".png", ".jpeg", ".jpg"]
                                           }'>
                                        </label>
                                        <h5>@lang('Image size should be') {{config('filelocation.blog.banner_img')}} @lang('for better resolution')</h5>
                                        @error("banner_image")
                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                        @enderror
                                    </div>
