                                                        ...
                                                        @if($type == "file" && $language->default_status == 1)
                                                            <div class="col-md-4">
                                                                ...
                                                                <label class="form-check form-check-dashed"
                                                                    ...
                                                                    <img id="contentImgDefault{{$loop->index}}"
                                                                    ...
                                                                    <img id="contentImgDark{{$loop->index}}"
                                                                         class="avatar avatar-xl avatar-4x3 avatar-centered h-100 mb-2"
                                                                         src="{{ getFile(!$singleContentData->isEmpty()  ? @$singleContentData[$language->id][0]->content->media->{$name}->driver: '', (!$singleContentData->isEmpty())? @$singleContentData[$language->id][0]->content->media->{$name}->path:'', true) }}"
                                                                         alt="Image Description"
                                                                    ...
                                                                    <input type="file" name="{{ $name }}"
                                                                           ...
                                                                           "textTarget": "#contentImgDefault{{$loop->index}}",
                                                                           "mode": "image",
                                                                           "targetAttr": "src",
...
@push('script')
    <script defer>
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '.js-file-attach', function(e) {
                var file = e.target.files[0];
                var targetImg = $(this).data('hs-file-attach-options')?.textTarget;
                if (file && targetImg) {
