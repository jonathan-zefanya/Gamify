<div class="col-xl-5">
    <div class="row g-5">
        ...
        <div class="col-xl-6 col-sm-6 col-lg-3">
            <!-- Card -->
            <a class="card user-card card-hover-shadow h-100" href="javascript:void(0)" id="orderRecord">
                <div class="card-body">
                    <div class="card-title-top">
                        <i class="fa-light fa-hourglass-end"></i>
                        <h6 class="card-subtitle">@lang("This Month Order")</h6>
                    </div>
                    <div class="row align-items-center gx-2 mb-1">
                        <div class="col-6">
                            <h2 class="card-title text-inherit orderRecord-pendingOrders"></h2>
                        </div>
                        <div class="col-6">
                            <div class="chartjs-custom" style="height: 3rem;">
...
@push('script')
    ...
    <script>
        ...
        async function updateChartorderRecordsGraph() {
            let $url = "{{ route('admin.chartOrderRecords') }}"
            await axios.get($url)
                .then(function (res) {

                    $('.orderRecord-pendingOrders').text(res.data.orderRecord.totalOrder);
