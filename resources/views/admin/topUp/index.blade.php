...
@section('page_title','Direct Top Up')
@section('content')
    <div class="content container-fluid">
        <x-page-header menu="Top Up" :statBtn="true"/>

        <div class="row d-none" id="statsSection">
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Active TopUp")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$topUps['activeTopUp']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$topUps['totalTopUp']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-success text-success p-1">
                                <i class="bi-graph-up"></i> {{fractionNumber($topUps['activeTopUpPercentage'])??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("InActive TopUp")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$topUps['inActiveTopUp']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$topUps['totalTopUp']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-danger text-danger p-1">
                                <i class="bi-graph-up"></i> {{fractionNumber($topUps['inActiveTopUpPercentage'])??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Today Created TopUp")</h6>

                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$topUps['todayTopUp']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$topUps['totalTopUp']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-info text-info p-1">
                                <i class="bi-graph-down"></i> {{$topUps['todayTopUpPercentage']??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("This Month Created TopUp")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$topUps['thisMonthTopUp']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">from {{$topUps['totalTopUp']??0}}</span>
                            </div>
                            <div class="col-auto">
                                <span class="badge bg-soft-success text-success p-1">{{fractionNumber($topUps['thisMonthTopUpPercentage'])??0}}%</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header card-header-content-md-between">
                        ...
                        <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                            ...
                            <a class="btn btn-primary btn-sm" href="{{route('admin.topUpStore')}}">
                                <i class="fas fa-tags me-1"></i> @lang('Create Top Up')
                            </a>
                            <div class="dropdown">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="filter_form">
                                                <div class="mb-4">
                                                            <span
                                                                class="text-cap text-body">@lang('Top Up Name')</span>
                                                    <div class="row">
                                                        <div class="col-12">
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route("admin.topUpListSearch").'?category_id='.$category_id }}",
                },
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.topUpListSearch").'?category_id='.$category_id }}" + "&name=" + name +
            ...
            $(document).on('click', '.change-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.topUpMultipleStatusChange') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
                    success: function (data) {
