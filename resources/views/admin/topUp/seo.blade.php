...
@section('page_title',__('Top Up SEO'))
@section('content')
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-title h4">@lang($topUp->name . ' Page SEO')</h2>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.topUpSeo', $topUp->id) }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('meta_title', $topUp->meta_title) }}" autocomplete="off">
                                        @error('meta_title')
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <div class="tom-select-custom">
                                            <select class="js-select form-select" name="meta_keywords[]"
                                                ...
                                                @if($topUp->meta_keywords)
                                                    @foreach($topUp->meta_keywords as $key => $data)
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <textarea id="metaDescription" class="form-control" name="meta_description"
                                                  ...
                                                  rows="4">{{ old("meta_description", $topUp->meta_description) }}</textarea>
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <textarea id="ogDescription" class="form-control" name="og_description"
                                                  ...
                                                  rows="4">{{ old("og_description", $topUp->og_description) }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="tom-select-custom tom-select-custom-with-tags">
                                        <select class="js-select form-select meta-robot-select2" autocomplete="off"
                                            ...
                                            <option
                                                value="index" {{ in_array("index", $topUp->getMetaRobots()) ? 'selected' : '' }}>
                                                Index
                                            </option>
                                            <option
                                                value="noindex" {{ in_array("noindex", $topUp->getMetaRobots()) ? 'selected' : '' }}>
                                                No index
                                            </option>
                                            <option
                                                value="follow" {{ in_array("follow", $topUp->getMetaRobots()) ? 'selected' : '' }}>
                                                Follow
                                            </option>
                                            <option
                                                value="nofollow" {{ in_array("nofollow", $topUp->getMetaRobots()) ? 'selected' : '' }}>
                                                No follow
                                            </option>
                                            <option
                                                value="noarchive" {{ in_array("noarchive", $topUp->getMetaRobots()) ? 'selected' : '' }}>
                                                Noarchive
                                            </option>
                                            <option
                                                value="nosnippet" {{ in_array("nosnippet", $topUp->getMetaRobots()) ? 'selected' : '' }}>
                                                Nosnippet
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-5 mb-3 mb-md-0">
                                        ...
                                        <label class="form-check form-check-dashed" for="imageUploader">
                                            <img id="SeoImg"
                                                 ...
                                                 src="{{ getFile($topUp->meta_image_driver, $topUp->meta_image, true) }}"
