...
@section('content')
    <div class="content container-fluid">
        ...
        <x-page-header menu="`{{$topUp->name}}` Service " pagetitle="`{{$topUp->name}}` Service " :statBtn="true" exportImport/>
    ...
    @include('admin.topUp.service.create-edit-modal')
    @include('admin.topUp.service.export-import-modal')
@endsection
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route("admin.topUpService.search").'?top_up_id='.$topUp->id }}",
                },
            ...
            $('.js-sortable').on('change', function () {
                ...
                $.ajax({
                    'url': "{{ route('admin.topUpService.sort') }}",
                    'method': "POST",
                    'data': {sort: methods}
                })
            })
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.topUpService.search").'?top_up_id='.$topUp->id }}" + "&name=" + name +
            ...
            $(document).on('click', '.delete-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.topUpService.multipleDelete') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
            ...
            $(document).on('click', '.change-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.topUpService.multipleStatusChange') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
                    success: function (data) {
