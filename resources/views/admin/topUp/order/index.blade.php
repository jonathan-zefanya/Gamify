...
@section('page_title','Direct Top Up Orders')
@section('content')
    <div class="content container-fluid">
        <x-page-header menu="Top up Oder" :statBtn="true"/>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route("admin.orderTopUp.listSearch").'?type='.$status }}",
                },
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.orderTopUp.listSearch") }}" + "?type=" + "{{$status}}" + "&name=" + name + "&service=" + service + "&filterDate=" + filterDate + "&filterStatus=" + filterStatus).load();
            });
