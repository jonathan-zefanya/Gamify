...
@section('page_title',__('Create Direct Top Up'))
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item"><a class="breadcrumb-link"
                                                           href="javascript:void(0);">@lang('Create Direct Top Up')</a>
                            </li>
                    ...
                    <div class="d-grid gap-3 gap-lg-5">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h4 class="card-title mt-2">@lang("Create Direct Top Up")</h4>
                            </div>
                            <div class="card-body mt-2">
                                <form action="{{route('admin.topUpStore')}}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                @include('admin.topUp.partials.create-image')
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row my-4 showField">
                                        @include('admin.topUp.partials.create-dynamic-field')
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
