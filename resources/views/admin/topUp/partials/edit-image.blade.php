<div class="col-md-4 mb-3">
    ...
    <div class="mb-3 mb-md-0">
        <label class="form-check form-check-dashed" for="logoUploader">
            <img id="otherImg"
                 ...
                 src="{{ getFile($topUp->image->image_driver??null,$topUp->image->image??null, true) }}"
    ...
    <span
        class="text-primary">@lang('Note: Image size should be ') {{config('filelocation.topUp.image_size')}} @lang('for better resolution')</span>
</div>
...
<div class="col-md-4 mb-3">
    ...
    <div class="mb-3 mb-md-0">
        <label class="form-check form-check-dashed" for="previewUploader">
            <img id="previewImg"
                 class="avatar avatar-xl avatar-4x3 avatar-centered h-100 mb-2"
                 src="{{ getFile($topUp->image->preview_driver??null,$topUp->image->preview??null, true) }}"
                 alt="@lang("File Storage Logo")"
                 data-hs-theme-appearance="default">
    ...
    <span
        class="text-primary">@lang('Note: Image size should be ') {{config('filelocation.topUp.preview_size')}} @lang('for better resolution')</span>
</div>
