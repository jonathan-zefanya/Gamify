                                    ...
                                    <table
                                        ...
                                        @forelse($transactions as $key =>  $transaction)
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="mb-0 {{ $transaction->trx_type == '+' ? 'text-success' : 'text-danger' }}">{{ $transaction->trx_type . currencyPosition($transaction->amount_in_base) }}</h6>
                                                </td>
                                    ...
                                    <table
                                        ...
                                        @forelse($paymentLog as $key =>  $payment)
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="mb-0 {{ $payment->getStatusClass() }}">{{ currencyPosition($payment->amount_in_base) }}</h6>
                                                </td>
                                                <td>
                                                    @if ($payment->status == 1)
                                                        <span
