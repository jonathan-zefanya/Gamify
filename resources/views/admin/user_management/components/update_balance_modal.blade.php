    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="addBalanceModalLabel">
                    <i class="fa-light fa-square-check"></i> @lang('Manage Balance')
                </h3>
            ...
            <form action="" method="post" class="setBalanceRoute">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group input-group-sm-vertical mt-3">
                        <label class="form-control" for="editUserModalAccountTypeModalRadioEg1_2">
                            <span class="form-check">
                              ...
                              <span class="form-check-label">
                                <i class="bi bi-plus"></i> @lang("Add Balance")
                              </span>
                            </span>
                        </label>
                        ...
                        <span class="form-check">
                          ...
                          <span class="form-check-label">
                            <i class="bi bi-dash me"></i> @lang("Subtract Balance")
                          </span>
                        </span>
                        </label>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="confirmButton">@lang('Confirm')</button>
                </div>
            </form>
        </div>
    </div>
...
@push('script')
    <script>
        $(document).ready(function () {
            ...
            const form = document.querySelector('.setBalanceRoute');
