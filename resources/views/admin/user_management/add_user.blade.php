                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <label for="passwordLabel"
                                           class="col-sm-3 col-form-label form-label">@lang('Password')</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="password" id="passwordLabel"
                                               value="{{ old("password") }}"
                                ...
                                <div class="row mb-4">
                                    <label for="codeLabel"
                                           class="col-sm-3 col-form-label form-label">@lang('Phone Code')</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="js-input-mask form-control" name="phone_code"
                                               id="codeLabel" placeholder="Phone Code"
                                               aria-label="Phone Code" value="{{ old('phone_code') }}"
                                               autocomplete="off">
                                        @error('phone_code')
                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                        @enderror
                        ...
                        <div id="addUserStepConfirmation" class="card card-lg">
                            ...
                            <div class="card-body">
                                <dl class="row">
                                    ...
                                    <dt class="col-sm-6 text-sm-end mb-2">@lang('Password:')</dt>
                                    <dd class="col-sm-6 password">-</dd>
...
@push('script')
    <script>
        ...
        function updatePasswordText() {
            let passwordValue = $("#passwordLabel").val();
            let add = $('.addUserBtn');
        ...
        $(document).on("input", "#passwordLabel", updatePasswordText);
        updatePasswordText();
