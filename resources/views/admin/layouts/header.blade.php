            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account admin_dropdown_account"
                                ...
                                <div class="d-flex align-items-center justify-content-start gap-2">
                                    ...
                                    <div>
                                        ...
                                        @else
                                            ...
                                            <p class="card-text text-body">Please log in to see your details.</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
