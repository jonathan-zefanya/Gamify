                                ...
                                <div class="card">
                                    ...
                                    <div class="table-responsive position-relative">
                                        <table
                                            ...
                                            @php
                                                $oldReceivableCurrency = count((array) old('receivable_currencies', $method->receivable_currencies));
                                            @endphp

                                            @if($oldReceivableCurrency > 0)
                                                @php
                                                    $receivables = is_array($method->receivable_currencies)
                                                        ? $method->receivable_currencies
                                                        : (array) $method->receivable_currencies;
                                                @endphp
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="mb-1">
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       value="{{ old('receivable_currencies.'.$i.'.currency', $receivables[$i]->currency ?? '') }}"
                                                                       autocomplete="off">
                                                        ...
                                                        <td>
                                                            <div class="input-group mb-1">
                                                                ...
                                                                <input type="text"
                                                                       class="form-control @error('receivable_currencies.'.$i.'.conversion_rate') is-invalid @enderror"
                                                                       name="receivable_currencies[{{ $i }}][conversion_rate]"
                                                                       value="{{ old('receivable_currencies.'.$i.'.conversion_rate', $receivables[$i]->conversion_rate ?? '') }}"
                                                                       autocomplete="off">
                                                                <span
                                                                    class="input-group-text">{{ old('receivable_currencies.'.$i.'.currency', $receivables[$i]->currency ?? '') }}</span>
                                                        ...
                                                        <td>
                                                            <div class="input-group mb-1">
                                                                <input type="text"
                                                                       class="form-control @error('receivable_currencies.'.$i.'.min_limit') is-invalid @enderror"
                                                                       name="receivable_currencies[{{ $i }}][min_limit]"
                                                                       aria-label="Amount (to the nearest dollar)"
                                                                       value="{{ old('receivable_currencies.'.$i.'.min_limit', $receivables[$i]->min_limit ?? '')  }}"
                                                                       autocomplete="off">
                                                                <span
                                                                    class="input-group-text">{{ old('receivable_currencies.'.$i.'.currency', $receivables[$i]->currency ?? '') }}</span>
                                                        ...
                                                        <td>
                                                            <div class="input-group mb-1">
                                                                <input type="text"
                                                                       class="form-control @error('receivable_currencies.'.$i.'.max_limit') is-invalid @enderror"
                                                                       name="receivable_currencies[{{$i}}][max_limit]"
                                                                       aria-label="Amount (to the nearest dollar)"
                                                                       value="{{ old('receivable_currencies.'.$i.'.max_limit', $receivables[$i]->max_limit ?? '') }}"
                                                                       autocomplete="off">
                                                                <span
                                                                    class="input-group-text">{{ old('receivable_currencies.'.$i.'.currency', $receivables[$i]->currency ?? '') }}</span>
                                                        ...
                                                        <td>
                                                            <div class="input-group mb-1">
                                                                <input type="text"
                                                                       class="form-control @error('receivable_currencies.'.$i.'.percentage_charge') is-invalid @enderror"
                                                                       name="receivable_currencies[{{ $i }}][percentage_charge]"
                                                                       aria-label="Amount (to the nearest dollar)"
                                                                       value="{{ old('receivable_currencies.'.$i.'.percentage_charge', $receivables[$i]->percentage_charge ?? '') }}"
                                                                       autocomplete="off">
                                                                <span
                                                        ...
                                                        <td>
                                                            <div class="input-group mb-1">
                                                                <input type="text"
                                                                       class="form-control @error('receivable_currencies.'.$i.'.fixed_charge') is-invalid @enderror"
                                                                       name="receivable_currencies[{{ $i }}][fixed_charge]"
                                                                       aria-label="Amount (to the nearest dollar)"
                                                                       value="{{ old('receivable_currencies.'.$i.'.fixed_charge', $receivables[$i]->fixed_charge ?? '') }}"
                                                                       autocomplete="off">
                                                                <span
                                                                    class="input-group-text">{{ old('receivable_currencies.'.$i.'.currency', $receivables[$i]->currency ?? '') }}</span>
