...
@section('page_title',__('Card SEO'))
@section('content')
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-title h4">@lang($card->name . ' Page SEO')</h2>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.card.seo', $card->id) }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('meta_title', $card->meta_title) }}" autocomplete="off">
                                        @error('meta_title')
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <div class="tom-select-custom">
                                            <select class="js-select form-select" name="meta_keywords[]"
                                                ...
                                                @if($card->meta_keywords)
                                                    @foreach($card->meta_keywords as $key => $data)
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <textarea id="metaDescription" class="form-control" name="meta_description"
                                                  ...
                                                  rows="4">{{ old("meta_description", $card->meta_description) }}</textarea>
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <textarea id="ogDescription" class="form-control" name="og_description"
                                                  ...
                                                  rows="4">{{ old("og_description", $card->og_description) }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="tom-select-custom tom-select-custom-with-tags">
                                        <select class="js-select form-select meta-robot-select2" autocomplete="off"
                                            ...
                                            <option
                                                value="index" {{ in_array("index", $card->getMetaRobots()) ? 'selected' : '' }}>
                                                Index
                                            </option>
                                            <option
                                                value="noindex" {{ in_array("noindex", $card->getMetaRobots()) ? 'selected' : '' }}>
                                                No index
                                            </option>
                                            <option
                                                value="follow" {{ in_array("follow", $card->getMetaRobots()) ? 'selected' : '' }}>
                                                Follow
                                            </option>
                                            <option
                                                value="nofollow" {{ in_array("nofollow", $card->getMetaRobots()) ? 'selected' : '' }}>
                                                No follow
                                            </option>
                                            <option
                                                value="noarchive" {{ in_array("noarchive", $card->getMetaRobots()) ? 'selected' : '' }}>
                                                Noarchive
                                            </option>
                                            <option
                                                value="nosnippet" {{ in_array("nosnippet", $card->getMetaRobots()) ? 'selected' : '' }}>
                                                Nosnippet
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-5 mb-3 mb-md-0">
                                        ...
                                        <label class="form-check form-check-dashed" for="imageUploader">
                                            <img id="SeoImg"
                                                 ...
                                                 src="{{ getFile($card->meta_image_driver, $card->meta_image, true) }}"
