    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>@lang('This CSV file provides detailed information on card services, including relevant data for each service offered.')</p>

                <div class="modal-footer gap-3">
                    <button type="button" class="btn btn-white" data-bs-dismiss="modal"
                            aria-label="Close">@lang('Cancel')
                    </button>
                    <a href="{{route('admin.cardService.export').'?card_id='.$card->id}}"
...
<div class="modal fade" id="importProductsModal" tabindex="-1" aria-labelledby="importProductsModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{route('admin.cardService.import').'?card_id='.$card->id}}" method="POST"
                  enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <p><a class="link"
                          href="{{route('admin.cardService.sample')}}">@lang('Download a sample CSV template')</a> @lang('to see an example of the format
                    required').
                    </p>
